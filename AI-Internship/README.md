...
![Difficulty](https://img.shields.io/badge/Level-Entry%20to%20Mid-green)
![Focus](https://img.shields.io/badge/Focus-AI%20%2B%20Legacy%20Modernization-purple)
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  1. 📖 READ     →  01-Getting-Started/00-Before-You-Begin.md            │
│                    (Understand expectations & mindset)                   │
│                                                                          │
│  2. 📋 REVIEW   →  08-Exercises/01-Pre-Internship-Requirements.md       │
│                    (Your Week 1 deliverables)                           │
│                                                                          │
│  3. 🎯 CHOOSE   →  04-Target-Projects/01-Choosing-Your-Project.md       │
│                    (Pick ERPNext, OpenElis, or Bahmni)                  │
│                                                                          │
│  4. 🏗️  BUILD    →  Start coding your tool!                             │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```

**⚠️ IMPORTANT**: Read [Before You Begin](./01-Getting-Started/00-Before-You-Begin.md) first. It sets critical context about expectations.
...
<details>
<summary><strong>📈 Scale of Technical Debt (click to expand)</strong></summary>

| Metric | Value |
|--------|-------|
| Annual market | **$300B+** |
| Projects that fail | **70%** (due to lost business logic) |
| Business rules in code only | **85%** |

</details>

<details>
<summary><strong>❌ Why Current Approaches Fail (click to expand)</strong></summary>
...
│          (e.g., erpnext/accounts/doctype/sales_invoice/)                │
│                                                                          │
│  OUTPUT:                                                                 │
│    📄 entities.json        → Classes, functions, relationships          │
│    📊 relationships.mermaid → Call graph, dependencies                  │
│    📝 summary.md           → What you discovered                        │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| Capability | AI Technique | Your Implementation |
|------------|--------------|---------------------|
| 🔍 Semantic Search | RAG, Embeddings | Find by meaning, not keywords |
| 🕸️ Graph Traversal | GraphRAG | "What calls this function?" |
| 🏷️ Domain Discovery | Clustering | Find bounded contexts |
| 💥 Impact Analysis | Graph Algorithms | "What breaks if I change X?" |
...
- 🗺️ **Graph View**: Visualize document connections
...
- **Documentation**: This vault (you're reading it!)
- **Mentors**: Available for questions (after you've tried first)

**Remember**: We're evaluating your ability to figure things out independently. Research first, ask second.

---

<p align="center">
<em>Good luck! Show us what you've got. 🚀</em>
</p>
